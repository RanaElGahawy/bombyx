...
THREAD(check_matrix) {
    ...
    if (((largs->x * largs->y) == 1)) {
        tmp = check_block(largs->R,largs->v);
...
THREAD(add_matrix) {
    ...
    if (((largs->x + largs->y) == 2)) {
        flops = add_block(largs->T,largs->R);
        SEND_ARGUMENT(largs->k, flops);
    } else {
        _tmp1 = 0LL;
        _tmp2 = 0LL;
        if ((largs->x > largs->y)) {
            ...
            ((add_matrix_cont1_closure*)SN_add_matrix_cont1.cls.get())->flops = flops;
            ...
            ((add_matrix_cont0_closure*)SN_add_matrix_cont0.cls.get())->flops = flops;
...
THREAD(multiply_matrix) {
    ...
    if ((((largs->x + largs->y) + largs->z) == 3)) {
        _tmp = 0LL;
        if (largs->add) {
            _tmp = mult_add_block(largs->A,largs->B,largs->R);
        } else {
            _tmp = multiply_block(largs->A,largs->B,largs->R);
        }
        ...
        if (((largs->x >= largs->y) && (largs->x >= largs->z))) {
            ...
            cont sp0k;
            SN_BIND(SN_multiply_matrix_cont3, &sp0k, _tmp1);
            ...
            cont sp1k;
            SN_BIND(SN_multiply_matrix_cont3, &sp1k, _tmp2);
            ...
            ((multiply_matrix_cont3_closure*)SN_multiply_matrix_cont3.cls.get())->flops = flops;
            ...
            if (((largs->y > largs->x) && (largs->y > largs->z))) {
                ...
                cont sp2k;
                SN_BIND(SN_multiply_matrix_cont1, &sp2k, _tmp1);
                ...
                ((multiply_matrix_cont1_closure*)SN_multiply_matrix_cont1.cls.get())->flops = flops;
                ...
                cont sp3k;
                SN_BIND(SN_multiply_matrix_cont0, &sp3k, _tmp1);
                ...
                cont sp4k;
                SN_BIND(SN_multiply_matrix_cont0, &sp4k, _tmp2);
                ...
                ((multiply_matrix_cont0_closure*)SN_multiply_matrix_cont0.cls.get())->flops = flops;
...
THREAD(multiply_matrix_afterif1) {
    ...
    ((multiply_matrix_afterif1_cont0_closure*)SN_multiply_matrix_afterif1_cont0.cls.get())->_tmp2 = largs->_tmp2;
    ((multiply_matrix_afterif1_cont0_closure*)SN_multiply_matrix_afterif1_cont0.cls.get())->_tmp1 = largs->_tmp1;
    // Original sync was here
    return;
}
THREAD(multiply_matrix_afterif2) {
...
THREAD(multiply_matrix_cont1) {
    ...
    cont sp0k;
    SN_BIND(SN_multiply_matrix_cont2, &sp0k, _tmp2);
    multiply_matrix_closure sp0c(sp0k);
    sp0c.A = largs->A;
    sp0c.oa = largs->oa;
    sp0c.B = largs->B;
    ...
    ((multiply_matrix_cont2_closure*)SN_multiply_matrix_cont2.cls.get())->_tmp1 = largs->_tmp1;
    ((multiply_matrix_cont2_closure*)SN_multiply_matrix_cont2.cls.get())->flops = largs->flops;
