...
CLOSURE_DEF(compute_w_coefficients, int n; int a; int b; COMPLEX * W;);
CLOSURE_DEF(unshuffle, int a; int b; COMPLEX * in; COMPLEX * out; int r;
            int m;);
CLOSURE_DEF(fft_twiddle_gen, int i; int i1; COMPLEX * in; COMPLEX * out;
            COMPLEX * W; int nW; int nWdn; int r; int m;);
CLOSURE_DEF(fft_twiddle_2, int a; int b; COMPLEX * in; COMPLEX * out;
            COMPLEX * W; int nW; int nWdn; int m;);
CLOSURE_DEF(fft_unshuffle_2, int a; int b; COMPLEX * in; COMPLEX * out; int m;);
CLOSURE_DEF(fft_twiddle_4, int a; int b; COMPLEX * in; COMPLEX * out;
            COMPLEX * W; int nW; int nWdn; int m;);
CLOSURE_DEF(fft_unshuffle_4, int a; int b; COMPLEX * in; COMPLEX * out; int m;);
CLOSURE_DEF(fft_twiddle_8, int a; int b; COMPLEX * in; COMPLEX * out;
            COMPLEX * W; int nW; int nWdn; int m;);
CLOSURE_DEF(fft_unshuffle_8, int a; int b; COMPLEX * in; COMPLEX * out; int m;);
CLOSURE_DEF(fft_twiddle_16, int a; int b; COMPLEX * in; COMPLEX * out;
            COMPLEX * W; int nW; int nWdn; int m;);
CLOSURE_DEF(fft_unshuffle_16, int a; int b; COMPLEX * in; COMPLEX * out;
            int m;);
CLOSURE_DEF(fft_twiddle_32, int a; int b; COMPLEX * in; COMPLEX * out;
            COMPLEX * W; int nW; int nWdn; int m;);
CLOSURE_DEF(fft_unshuffle_32, int a; int b; COMPLEX * in; COMPLEX * out;
            int m;);
CLOSURE_DEF(fft_aux, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW;);
CLOSURE_DEF(test_fft_elem, int n; int j; COMPLEX * in; COMPLEX * out;);
CLOSURE_DEF(fft_aux_afterif0, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif0_afterif1, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif0_afterif2, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif0_afterif3, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif0_afterif4, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif0_afterif5, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif6, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif7, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif8, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif9, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif10, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
...
CLOSURE_DEF(fft_aux_cont0, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_cont1, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_cont2, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_cont3, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_cont4, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_cont5, int n; COMPLEX * in; COMPLEX * out; int *factors;
            COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(cilk_fft_cont0, int n; COMPLEX * in; COMPLEX * out; int factors[40];
            COMPLEX * W;);
CLOSURE_DEF(cilk_fft_cont1, COMPLEX *W;);
CLOSURE_DEF(test_fft_cont0, );
CLOSURE_DEF(fft_aux_afterif0_cont0, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif0_cont1, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif0_cont2, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif0_cont3, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif0_cont4, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif0_cont5, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
CLOSURE_DEF(fft_aux_afterif6_cont0, int n; COMPLEX * in; COMPLEX * out;
            int *factors; COMPLEX * W; int nW; int r; int m; int k0; int k1;);
...
THREAD(compute_w_coefficients) {
  ...
  REAL c;
  int ab;
  compute_w_coefficients_closure *largs =
      (compute_w_coefficients_closure *)(args.get());
  if (((largs->b - largs->a) < 128)) {
    ...
    compute_w_coefficients_cont0_closure SN_compute_w_coefficients_cont0c(
        largs->k);
    spawn_next<compute_w_coefficients_cont0_closure>
        SN_compute_w_coefficients_cont0(SN_compute_w_coefficients_cont0c);
    cont sp0k;
...
THREAD(fft_twiddle_gen) {
  ...
  if ((largs->i == (largs->i1 - 1))) {
    fft_twiddle_gen1((largs->in + largs->i), (largs->out + largs->i), largs->W,
                     largs->r, largs->m, largs->nW, (largs->nWdn * largs->i),
                     (largs->nWdn * largs->m));
    SEND_ARGUMENT(largs->k, 0);
  } else {
    i2 = ((largs->i + largs->i1) / 2);
    fft_twiddle_gen_cont0_closure SN_fft_twiddle_gen_cont0c(largs->k);
    spawn_next<fft_twiddle_gen_cont0_closure> SN_fft_twiddle_gen_cont0(
        SN_fft_twiddle_gen_cont0c);
    cont sp0k;
...
THREAD(fft_twiddle_2) {
  ...
  if (((largs->b - largs->a) < 128)) {
    ...
    spawn_next<fft_twiddle_2_cont0_closure> SN_fft_twiddle_2_cont0(
        SN_fft_twiddle_2_cont0c);
    cont sp0k;
...
THREAD(fft_unshuffle_2) {
  ...
  if (((largs->b - largs->a) < 128)) {
    ...
    spawn_next<fft_unshuffle_2_cont0_closure> SN_fft_unshuffle_2_cont0(
        SN_fft_unshuffle_2_cont0c);
    cont sp0k;
...
THREAD(fft_twiddle_4) {
  ...
  if (((largs->b - largs->a) < 128)) {
    ...
    spawn_next<fft_twiddle_4_cont0_closure> SN_fft_twiddle_4_cont0(
        SN_fft_twiddle_4_cont0c);
    cont sp0k;
...
THREAD(fft_unshuffle_4) {
  ...
  if (((largs->b - largs->a) < 128)) {
    ...
    spawn_next<fft_unshuffle_4_cont0_closure> SN_fft_unshuffle_4_cont0(
        SN_fft_unshuffle_4_cont0c);
    cont sp0k;
...
THREAD(fft_twiddle_8) {
  ...
  if (((largs->b - largs->a) < 128)) {
    ...
    spawn_next<fft_twiddle_8_cont0_closure> SN_fft_twiddle_8_cont0(
        SN_fft_twiddle_8_cont0c);
    cont sp0k;
...
THREAD(fft_unshuffle_8) {
  ...
  if (((largs->b - largs->a) < 128)) {
    ...
    spawn_next<fft_unshuffle_8_cont0_closure> SN_fft_unshuffle_8_cont0(
        SN_fft_unshuffle_8_cont0c);
    cont sp0k;
...
THREAD(fft_twiddle_16) {
  ...
  if (((largs->b - largs->a) < 128)) {
    ...
    spawn_next<fft_twiddle_16_cont0_closure> SN_fft_twiddle_16_cont0(
        SN_fft_twiddle_16_cont0c);
    cont sp0k;
...
THREAD(fft_unshuffle_16) {
  ...
  if (((largs->b - largs->a) < 128)) {
    ...
    spawn_next<fft_unshuffle_16_cont0_closure> SN_fft_unshuffle_16_cont0(
        SN_fft_unshuffle_16_cont0c);
    cont sp0k;
...
THREAD(fft_twiddle_32) {
  ...
  if (((largs->b - largs->a) < 128)) {
    ...
    spawn_next<fft_twiddle_32_cont0_closure> SN_fft_twiddle_32_cont0(
        SN_fft_twiddle_32_cont0c);
    cont sp0k;
...
THREAD(fft_unshuffle_32) {
  ...
  if (((largs->b - largs->a) < 128)) {
    ...
    spawn_next<fft_unshuffle_32_cont0_closure> SN_fft_unshuffle_32_cont0(
        SN_fft_unshuffle_32_cont0c);
    cont sp0k;
          ...
          if ((largs->n == 2)) {
            ...
            if ((r < largs->n)) {
              if ((r == 32)) {
                ...
                spawn_next<fft_aux_cont5_closure> SN_fft_aux_cont5(
                    SN_fft_aux_cont5c);
                cont sp0k;
                ...
                ((fft_aux_cont5_closure *)SN_fft_aux_cont5.cls.get())->nW =
                    largs->nW;
                ((fft_aux_cont5_closure *)SN_fft_aux_cont5.cls.get())->W =
                    largs->W;
                ((fft_aux_cont5_closure *)SN_fft_aux_cont5.cls.get())->factors =
                    largs->factors;
                ((fft_aux_cont5_closure *)SN_fft_aux_cont5.cls.get())->out =
                    largs->out;
                ((fft_aux_cont5_closure *)SN_fft_aux_cont5.cls.get())->in =
                    largs->in;
                ((fft_aux_cont5_closure *)SN_fft_aux_cont5.cls.get())->n =
                    largs->n;
                // Original sync was here
              } else {
                if ((r == 16)) {
                  fft_aux_cont4_closure SN_fft_aux_cont4c(largs->k);
                  spawn_next<fft_aux_cont4_closure> SN_fft_aux_cont4(
                      SN_fft_aux_cont4c);
                  cont sp1k;
                  ...
                  ((fft_aux_cont4_closure *)SN_fft_aux_cont4.cls.get())->k0 =
                      k0;
                  ((fft_aux_cont4_closure *)SN_fft_aux_cont4.cls.get())->k1 =
                      k1;
                  ((fft_aux_cont4_closure *)SN_fft_aux_cont4.cls.get())->m = m;
                  ((fft_aux_cont4_closure *)SN_fft_aux_cont4.cls.get())->r = r;
                  ((fft_aux_cont4_closure *)SN_fft_aux_cont4.cls.get())->nW =
                      largs->nW;
                  ((fft_aux_cont4_closure *)SN_fft_aux_cont4.cls.get())->W =
                      largs->W;
                  ((fft_aux_cont4_closure *)SN_fft_aux_cont4.cls.get())
                      ->factors = largs->factors;
                  ((fft_aux_cont4_closure *)SN_fft_aux_cont4.cls.get())->out =
                      largs->out;
                  ((fft_aux_cont4_closure *)SN_fft_aux_cont4.cls.get())->in =
                      largs->in;
                  ((fft_aux_cont4_closure *)SN_fft_aux_cont4.cls.get())->n =
                      largs->n;
                  // Original sync was here
                } else {
                  if ((r == 8)) {
                    fft_aux_cont3_closure SN_fft_aux_cont3c(largs->k);
                    spawn_next<fft_aux_cont3_closure> SN_fft_aux_cont3(
                        SN_fft_aux_cont3c);
                    cont sp2k;
                    ...
                    ((fft_aux_cont3_closure *)SN_fft_aux_cont3.cls.get())->k0 =
                        k0;
                    ((fft_aux_cont3_closure *)SN_fft_aux_cont3.cls.get())->k1 =
                        k1;
                    ((fft_aux_cont3_closure *)SN_fft_aux_cont3.cls.get())->m =
                        m;
                    ((fft_aux_cont3_closure *)SN_fft_aux_cont3.cls.get())->r =
                        r;
                    ((fft_aux_cont3_closure *)SN_fft_aux_cont3.cls.get())->nW =
                        largs->nW;
                    ((fft_aux_cont3_closure *)SN_fft_aux_cont3.cls.get())->W =
                        largs->W;
                    ((fft_aux_cont3_closure *)SN_fft_aux_cont3.cls.get())
                        ->factors = largs->factors;
                    ((fft_aux_cont3_closure *)SN_fft_aux_cont3.cls.get())->out =
                        largs->out;
                    ((fft_aux_cont3_closure *)SN_fft_aux_cont3.cls.get())->in =
                        largs->in;
                    ((fft_aux_cont3_closure *)SN_fft_aux_cont3.cls.get())->n =
                        largs->n;
                    // Original sync was here
                  } else {
                    if ((r == 4)) {
                      fft_aux_cont2_closure SN_fft_aux_cont2c(largs->k);
                      spawn_next<fft_aux_cont2_closure> SN_fft_aux_cont2(
                          SN_fft_aux_cont2c);
                      cont sp3k;
                      ...
                      ((fft_aux_cont2_closure *)SN_fft_aux_cont2.cls.get())
                          ->k0 = k0;
                      ((fft_aux_cont2_closure *)SN_fft_aux_cont2.cls.get())
                          ->k1 = k1;
                      ((fft_aux_cont2_closure *)SN_fft_aux_cont2.cls.get())->m =
                          m;
                      ((fft_aux_cont2_closure *)SN_fft_aux_cont2.cls.get())->r =
                          r;
                      ((fft_aux_cont2_closure *)SN_fft_aux_cont2.cls.get())
                          ->nW = largs->nW;
                      ((fft_aux_cont2_closure *)SN_fft_aux_cont2.cls.get())->W =
                          largs->W;
                      ((fft_aux_cont2_closure *)SN_fft_aux_cont2.cls.get())
                          ->factors = largs->factors;
                      ((fft_aux_cont2_closure *)SN_fft_aux_cont2.cls.get())
                      ...
                      ((fft_aux_cont2_closure *)SN_fft_aux_cont2.cls.get())
                          ->in = largs->in;
                      ((fft_aux_cont2_closure *)SN_fft_aux_cont2.cls.get())->n =
                          largs->n;
                      // Original sync was here
                    } else {
                      if ((r == 2)) {
                        fft_aux_cont1_closure SN_fft_aux_cont1c(largs->k);
                        spawn_next<fft_aux_cont1_closure> SN_fft_aux_cont1(
                            SN_fft_aux_cont1c);
                        cont sp4k;
                        ...
                        ((fft_aux_cont1_closure *)SN_fft_aux_cont1.cls.get())
                            ->k0 = k0;
                        ((fft_aux_cont1_closure *)SN_fft_aux_cont1.cls.get())
                            ->k1 = k1;
                        ((fft_aux_cont1_closure *)SN_fft_aux_cont1.cls.get())
                        ...
                        spawn_next<fft_aux_cont0_closure> SN_fft_aux_cont0(
                            SN_fft_aux_cont0c);
                        cont sp5k;
                        ...
                        ((fft_aux_cont0_closure *)SN_fft_aux_cont0.cls.get())
                            ->k0 = k0;
                        ((fft_aux_cont0_closure *)SN_fft_aux_cont0.cls.get())
                            ->k1 = k1;
                        ((fft_aux_cont0_closure *)SN_fft_aux_cont0.cls.get())
...
void cilk_fft(int n, COMPLEX *in, COMPLEX *out) {
  ...
  std::memcpy(((cilk_fft_cont0_closure *)SN_cilk_fft_cont0.cls.get())->factors,
...
THREAD(test_fft_elem) {
  ...
  for (i = 0; (i < largs->n); (++i)) {
    ...
    ((sum).re) +=
        ((largs->in[i]).re) * ((w).re) - ((largs->in[i]).im) * ((w).im);
    ((sum).im) +=
        ((largs->in[i]).im) * ((w).re) + ((largs->in[i]).re) * ((w).im);
  }
...
THREAD(fft_aux_afterif0) {
  ...
  if ((largs->r == 2)) {
    ...
    spawn_next<fft_aux_afterif0_cont5_closure> SN_fft_aux_afterif0_cont5(
        SN_fft_aux_afterif0_cont5c);
    cont sp0k;
    ...
    ((fft_aux_afterif0_cont5_closure *)SN_fft_aux_afterif0_cont5.cls.get())
        ->k1 = largs->k1;
    ((fft_aux_afterif0_cont5_closure *)SN_fft_aux_afterif0_cont5.cls.get())
        ->k0 = largs->k0;
    ((fft_aux_afterif0_cont5_closure *)SN_fft_aux_afterif0_cont5.cls.get())->m =
        largs->m;
    ((fft_aux_afterif0_cont5_closure *)SN_fft_aux_afterif0_cont5.cls.get())->r =
        largs->r;
    ((fft_aux_afterif0_cont5_closure *)SN_fft_aux_afterif0_cont5.cls.get())
        ->nW = largs->nW;
    ((fft_aux_afterif0_cont5_closure *)SN_fft_aux_afterif0_cont5.cls.get())->W =
        largs->W;
    ((fft_aux_afterif0_cont5_closure *)SN_fft_aux_afterif0_cont5.cls.get())
        ->factors = largs->factors;
    ((fft_aux_afterif0_cont5_closure *)SN_fft_aux_afterif0_cont5.cls.get())
    ...
    ((fft_aux_afterif0_cont5_closure *)SN_fft_aux_afterif0_cont5.cls.get())
        ->in = largs->in;
    ((fft_aux_afterif0_cont5_closure *)SN_fft_aux_afterif0_cont5.cls.get())->n =
        largs->n;
    // Original sync was here
  } else {
    if ((largs->r == 4)) {
      fft_aux_afterif0_cont4_closure SN_fft_aux_afterif0_cont4c(largs->k);
      spawn_next<fft_aux_afterif0_cont4_closure> SN_fft_aux_afterif0_cont4(
          SN_fft_aux_afterif0_cont4c);
      cont sp1k;
      ...
      ((fft_aux_afterif0_cont4_closure *)SN_fft_aux_afterif0_cont4.cls.get())
          ->k1 = largs->k1;
      ((fft_aux_afterif0_cont4_closure *)SN_fft_aux_afterif0_cont4.cls.get())
          ->k0 = largs->k0;
      ((fft_aux_afterif0_cont4_closure *)SN_fft_aux_afterif0_cont4.cls.get())
      ...
      if ((largs->r == 8)) {
        ...
        spawn_next<fft_aux_afterif0_cont3_closure> SN_fft_aux_afterif0_cont3(
            SN_fft_aux_afterif0_cont3c);
        cont sp2k;
        ...
        ((fft_aux_afterif0_cont3_closure *)SN_fft_aux_afterif0_cont3.cls.get())
            ->k1 = largs->k1;
        ((fft_aux_afterif0_cont3_closure *)SN_fft_aux_afterif0_cont3.cls.get())
            ->k0 = largs->k0;
        ((fft_aux_afterif0_cont3_closure *)SN_fft_aux_afterif0_cont3.cls.get())
        ...
        if ((largs->r == 16)) {
          ...
          spawn_next<fft_aux_afterif0_cont2_closure> SN_fft_aux_afterif0_cont2(
              SN_fft_aux_afterif0_cont2c);
          cont sp3k;
          ...
          ((fft_aux_afterif0_cont2_closure *)
               SN_fft_aux_afterif0_cont2.cls.get())
              ->k1 = largs->k1;
          ((fft_aux_afterif0_cont2_closure *)
               SN_fft_aux_afterif0_cont2.cls.get())
              ->k0 = largs->k0;
          ...
          if ((largs->r == 32)) {
            ...
            spawn_next<fft_aux_afterif0_cont1_closure>
                SN_fft_aux_afterif0_cont1(SN_fft_aux_afterif0_cont1c);
            cont sp4k;
            ...
            ((fft_aux_afterif0_cont1_closure *)
                 SN_fft_aux_afterif0_cont1.cls.get())
                ->k1 = largs->k1;
            ((fft_aux_afterif0_cont1_closure *)
                 SN_fft_aux_afterif0_cont1.cls.get())
                ->k0 = largs->k0;
            ...
            spawn_next<fft_aux_afterif0_cont0_closure>
                SN_fft_aux_afterif0_cont0(SN_fft_aux_afterif0_cont0c);
            cont sp5k;
            ...
            ((fft_aux_afterif0_cont0_closure *)
                 SN_fft_aux_afterif0_cont0.cls.get())
                ->k1 = largs->k1;
            ((fft_aux_afterif0_cont0_closure *)
                 SN_fft_aux_afterif0_cont0.cls.get())
                ->k0 = largs->k0;
...
THREAD(fft_aux_afterif0_afterif1) {
  fft_aux_afterif0_afterif1_closure *largs =
      (fft_aux_afterif0_afterif1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_aux_afterif0_afterif2) {
  fft_aux_afterif0_afterif2_closure *largs =
      (fft_aux_afterif0_afterif2_closure *)(args.get());
...
THREAD(fft_aux_afterif0_afterif3) {
  fft_aux_afterif0_afterif3_closure *largs =
      (fft_aux_afterif0_afterif3_closure *)(args.get());
...
THREAD(fft_aux_afterif0_afterif4) {
  fft_aux_afterif0_afterif4_closure *largs =
      (fft_aux_afterif0_afterif4_closure *)(args.get());
...
THREAD(fft_aux_afterif0_afterif5) {
  fft_aux_afterif0_afterif5_closure *largs =
      (fft_aux_afterif0_afterif5_closure *)(args.get());
...
THREAD(fft_aux_afterif6) {
  ...
  spawn_next<fft_aux_afterif6_cont0_closure> SN_fft_aux_afterif6_cont0(
      SN_fft_aux_afterif6_cont0c);
  for (largs->k1 = 0; (largs->k1 < largs->n);
       largs->k1 = (largs->k1 + largs->m)) {
    cont sp0k;
  ...
  ((fft_aux_afterif6_cont0_closure *)SN_fft_aux_afterif6_cont0.cls.get())->k1 =
      largs->k1;
  ((fft_aux_afterif6_cont0_closure *)SN_fft_aux_afterif6_cont0.cls.get())->k0 =
      largs->k0;
  ((fft_aux_afterif6_cont0_closure *)SN_fft_aux_afterif6_cont0.cls.get())->m =
      largs->m;
  ((fft_aux_afterif6_cont0_closure *)SN_fft_aux_afterif6_cont0.cls.get())->r =
      largs->r;
  ((fft_aux_afterif6_cont0_closure *)SN_fft_aux_afterif6_cont0.cls.get())->nW =
      largs->nW;
  ((fft_aux_afterif6_cont0_closure *)SN_fft_aux_afterif6_cont0.cls.get())->W =
      largs->W;
  ((fft_aux_afterif6_cont0_closure *)SN_fft_aux_afterif6_cont0.cls.get())
      ->factors = largs->factors;
  ((fft_aux_afterif6_cont0_closure *)SN_fft_aux_afterif6_cont0.cls.get())->out =
      largs->out;
  ((fft_aux_afterif6_cont0_closure *)SN_fft_aux_afterif6_cont0.cls.get())->in =
      largs->in;
  ((fft_aux_afterif6_cont0_closure *)SN_fft_aux_afterif6_cont0.cls.get())->n =
      largs->n;
  // Original sync was here
  return;
}
...
THREAD(compute_w_coefficients_cont0) {
  compute_w_coefficients_cont0_closure *largs =
      (compute_w_coefficients_cont0_closure *)(args.get());
  compute_w_coefficients_cont1_closure SN_compute_w_coefficients_cont1c(
      largs->k);
  spawn_next<compute_w_coefficients_cont1_closure>
      SN_compute_w_coefficients_cont1(SN_compute_w_coefficients_cont1c);
  // Original sync was here
  return;
}
THREAD(compute_w_coefficients_cont1) {
  compute_w_coefficients_cont1_closure *largs =
      (compute_w_coefficients_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(unshuffle_cont0) {
...
THREAD(fft_twiddle_gen_cont0) {
  fft_twiddle_gen_cont0_closure *largs =
      (fft_twiddle_gen_cont0_closure *)(args.get());
  fft_twiddle_gen_cont1_closure SN_fft_twiddle_gen_cont1c(largs->k);
  spawn_next<fft_twiddle_gen_cont1_closure> SN_fft_twiddle_gen_cont1(
      SN_fft_twiddle_gen_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_twiddle_gen_cont1) {
  fft_twiddle_gen_cont1_closure *largs =
      (fft_twiddle_gen_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_twiddle_2_cont0) {
  fft_twiddle_2_cont0_closure *largs =
      (fft_twiddle_2_cont0_closure *)(args.get());
  fft_twiddle_2_cont1_closure SN_fft_twiddle_2_cont1c(largs->k);
  spawn_next<fft_twiddle_2_cont1_closure> SN_fft_twiddle_2_cont1(
      SN_fft_twiddle_2_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_twiddle_2_cont1) {
  fft_twiddle_2_cont1_closure *largs =
      (fft_twiddle_2_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_unshuffle_2_cont0) {
  fft_unshuffle_2_cont0_closure *largs =
      (fft_unshuffle_2_cont0_closure *)(args.get());
  fft_unshuffle_2_cont1_closure SN_fft_unshuffle_2_cont1c(largs->k);
  spawn_next<fft_unshuffle_2_cont1_closure> SN_fft_unshuffle_2_cont1(
      SN_fft_unshuffle_2_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_unshuffle_2_cont1) {
  fft_unshuffle_2_cont1_closure *largs =
      (fft_unshuffle_2_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_twiddle_4_cont0) {
  fft_twiddle_4_cont0_closure *largs =
      (fft_twiddle_4_cont0_closure *)(args.get());
  fft_twiddle_4_cont1_closure SN_fft_twiddle_4_cont1c(largs->k);
  spawn_next<fft_twiddle_4_cont1_closure> SN_fft_twiddle_4_cont1(
      SN_fft_twiddle_4_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_twiddle_4_cont1) {
  fft_twiddle_4_cont1_closure *largs =
      (fft_twiddle_4_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_unshuffle_4_cont0) {
  fft_unshuffle_4_cont0_closure *largs =
      (fft_unshuffle_4_cont0_closure *)(args.get());
  fft_unshuffle_4_cont1_closure SN_fft_unshuffle_4_cont1c(largs->k);
  spawn_next<fft_unshuffle_4_cont1_closure> SN_fft_unshuffle_4_cont1(
      SN_fft_unshuffle_4_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_unshuffle_4_cont1) {
  fft_unshuffle_4_cont1_closure *largs =
      (fft_unshuffle_4_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_twiddle_8_cont0) {
  fft_twiddle_8_cont0_closure *largs =
      (fft_twiddle_8_cont0_closure *)(args.get());
  fft_twiddle_8_cont1_closure SN_fft_twiddle_8_cont1c(largs->k);
  spawn_next<fft_twiddle_8_cont1_closure> SN_fft_twiddle_8_cont1(
      SN_fft_twiddle_8_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_twiddle_8_cont1) {
  fft_twiddle_8_cont1_closure *largs =
      (fft_twiddle_8_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_unshuffle_8_cont0) {
  fft_unshuffle_8_cont0_closure *largs =
      (fft_unshuffle_8_cont0_closure *)(args.get());
  fft_unshuffle_8_cont1_closure SN_fft_unshuffle_8_cont1c(largs->k);
  spawn_next<fft_unshuffle_8_cont1_closure> SN_fft_unshuffle_8_cont1(
      SN_fft_unshuffle_8_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_unshuffle_8_cont1) {
  fft_unshuffle_8_cont1_closure *largs =
      (fft_unshuffle_8_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_twiddle_16_cont0) {
  fft_twiddle_16_cont0_closure *largs =
      (fft_twiddle_16_cont0_closure *)(args.get());
  fft_twiddle_16_cont1_closure SN_fft_twiddle_16_cont1c(largs->k);
  spawn_next<fft_twiddle_16_cont1_closure> SN_fft_twiddle_16_cont1(
      SN_fft_twiddle_16_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_twiddle_16_cont1) {
  fft_twiddle_16_cont1_closure *largs =
      (fft_twiddle_16_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_unshuffle_16_cont0) {
  fft_unshuffle_16_cont0_closure *largs =
      (fft_unshuffle_16_cont0_closure *)(args.get());
  fft_unshuffle_16_cont1_closure SN_fft_unshuffle_16_cont1c(largs->k);
  spawn_next<fft_unshuffle_16_cont1_closure> SN_fft_unshuffle_16_cont1(
      SN_fft_unshuffle_16_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_unshuffle_16_cont1) {
  fft_unshuffle_16_cont1_closure *largs =
      (fft_unshuffle_16_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_twiddle_32_cont0) {
  fft_twiddle_32_cont0_closure *largs =
      (fft_twiddle_32_cont0_closure *)(args.get());
  fft_twiddle_32_cont1_closure SN_fft_twiddle_32_cont1c(largs->k);
  spawn_next<fft_twiddle_32_cont1_closure> SN_fft_twiddle_32_cont1(
      SN_fft_twiddle_32_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_twiddle_32_cont1) {
  fft_twiddle_32_cont1_closure *largs =
      (fft_twiddle_32_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_unshuffle_32_cont0) {
  fft_unshuffle_32_cont0_closure *largs =
      (fft_unshuffle_32_cont0_closure *)(args.get());
  fft_unshuffle_32_cont1_closure SN_fft_unshuffle_32_cont1c(largs->k);
  spawn_next<fft_unshuffle_32_cont1_closure> SN_fft_unshuffle_32_cont1(
      SN_fft_unshuffle_32_cont1c);
  // Original sync was here
  return;
}
THREAD(fft_unshuffle_32_cont1) {
  fft_unshuffle_32_cont1_closure *largs =
      (fft_unshuffle_32_cont1_closure *)(args.get());
  SEND_ARGUMENT(largs->k, 0);
}
THREAD(fft_aux_cont0) {
...
THREAD(fft_aux_afterif0_cont0) {
  fft_aux_afterif0_cont0_closure *largs =
      (fft_aux_afterif0_cont0_closure *)(args.get());
...
THREAD(fft_aux_afterif0_cont1) {
  fft_aux_afterif0_cont1_closure *largs =
      (fft_aux_afterif0_cont1_closure *)(args.get());
  auto sp0c = std::make_shared<fft_aux_afterif0_afterif5_closure>(largs->k);
  sp0c->n = largs->n;
  sp0c->in = largs->in;
  sp0c->out = largs->out;
...
THREAD(fft_aux_afterif0_cont2) {
  fft_aux_afterif0_cont2_closure *largs =
      (fft_aux_afterif0_cont2_closure *)(args.get());
  auto sp0c = std::make_shared<fft_aux_afterif0_afterif4_closure>(largs->k);
  sp0c->n = largs->n;
  sp0c->in = largs->in;
  sp0c->out = largs->out;
...
THREAD(fft_aux_afterif0_cont3) {
  fft_aux_afterif0_cont3_closure *largs =
      (fft_aux_afterif0_cont3_closure *)(args.get());
  auto sp0c = std::make_shared<fft_aux_afterif0_afterif3_closure>(largs->k);
  sp0c->n = largs->n;
  sp0c->in = largs->in;
  sp0c->out = largs->out;
...
THREAD(fft_aux_afterif0_cont4) {
  fft_aux_afterif0_cont4_closure *largs =
      (fft_aux_afterif0_cont4_closure *)(args.get());
  auto sp0c = std::make_shared<fft_aux_afterif0_afterif2_closure>(largs->k);
  sp0c->n = largs->n;
  sp0c->in = largs->in;
  sp0c->out = largs->out;
...
THREAD(fft_aux_afterif0_cont5) {
  fft_aux_afterif0_cont5_closure *largs =
      (fft_aux_afterif0_cont5_closure *)(args.get());
  auto sp0c = std::make_shared<fft_aux_afterif0_afterif1_closure>(largs->k);
  sp0c->n = largs->n;
  sp0c->in = largs->in;
  sp0c->out = largs->out;
...
THREAD(fft_aux_afterif6_cont0) {
  fft_aux_afterif6_cont0_closure *largs =
      (fft_aux_afterif6_cont0_closure *)(args.get());
