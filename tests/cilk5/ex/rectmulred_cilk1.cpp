...
CLOSURE_DEF_SHARED(add_matrix, add_matrix_data);
CLOSURE_DEF_SHARED(init_matrix, init_matrix_data);
CLOSURE_DEF_SHARED(multiply_matrix, multiply_matrix_data);
CLOSURE_DEF_SHARED(run_afterif0, run_afterif0_data);
CLOSURE_DEF_SHARED(multiply_matrix_afterif1, multiply_matrix_data);
CLOSURE_DEF_SHARED(multiply_matrix_afterif2, multiply_matrix_data);
CLOSURE_DEF_SHARED(init_matrix_afterif3, init_matrix_data);
CLOSURE_DEF_SHARED(add_matrix_afterif4, add_matrix_data);
...
CLOSURE_DEF_SHARED(add_matrix_cont0, add_matrix_data);
CLOSURE_DEF_SHARED(add_matrix_cont1, add_matrix_data);
CLOSURE_DEF_SHARED(init_matrix_cont0, init_matrix_data);
CLOSURE_DEF_SHARED(init_matrix_cont1, init_matrix_data);
CLOSURE_DEF_SHARED(multiply_matrix_cont0, multiply_matrix_data);
CLOSURE_DEF_SHARED(multiply_matrix_cont1, multiply_matrix_data);
CLOSURE_DEF_SHARED(multiply_matrix_cont2, multiply_matrix_data);
CLOSURE_DEF_SHARED(multiply_matrix_cont3, multiply_matrix_data);
...
THREAD(check_matrix) {
    ...
    if (((largs->x * largs->y) == 1)) {
        ...
        if ((largs->x > largs->y)) {
            ...
            cont sp0k;
            SN_BIND_VOID(SN_check_matrix_cont1, &sp0k);
            ...
            cont sp1k;
            SN_BIND_VOID(SN_check_matrix_cont1, &sp1k);
            ...
            ((check_matrix_cont1_closure*)SN_check_matrix_cont1.cls.get())->b = b;
            ((check_matrix_cont1_closure*)SN_check_matrix_cont1.cls.get())->y = largs->y;
            ((check_matrix_cont1_closure*)SN_check_matrix_cont1.cls.get())->a = a;
...
THREAD(add_matrix) {
    ...
    if (((largs->x + largs->y) == 2)) {
        ...
        if ((largs->x > largs->y)) {
            ...
            *static_cast<add_matrix_data*>(SN_add_matrix_cont1.cls.get()) = *largs;
            // Original sync was here
        } else {
            ...
            *static_cast<add_matrix_data*>(SN_add_matrix_cont0.cls.get()) = *largs;
            // Original sync was here
        }
    }
}
...
THREAD(init_matrix) {
    ...
    if (((largs->x + largs->y) == 2)) {
        ...
        if ((largs->x > largs->y)) {
            ...
            *static_cast<init_matrix_data*>(SN_init_matrix_cont1.cls.get()) = *largs;
            // Original sync was here
        } else {
            ...
            *static_cast<init_matrix_data*>(SN_init_matrix_cont0.cls.get()) = *largs;
            // Original sync was here
        }
    }
}
THREAD(multiply_matrix) {
    ...
    if ((((largs->x + largs->y) + largs->z) == 3)) {
        ...
        if (((largs->x >= largs->y) && (largs->x >= largs->z))) {
            ...
            *static_cast<multiply_matrix_data*>(SN_multiply_matrix_cont3.cls.get()) = *largs;
            // Original sync was here
        } else {
            if (((largs->y > largs->x) && (largs->y > largs->z))) {
                ...
                *static_cast<multiply_matrix_data*>(SN_multiply_matrix_cont1.cls.get()) = *largs;
                // Original sync was here
            } else {
                ...
                *static_cast<multiply_matrix_data*>(SN_multiply_matrix_cont0.cls.get()) = *largs;
                // Original sync was here
            }
        }
    }
...
THREAD(multiply_matrix_cont1) {
    ...
    *static_cast<multiply_matrix_data*>(SN_multiply_matrix_cont2.cls.get()) = *largs;
    // Original sync was here
    return;
}
THREAD(multiply_matrix_cont2) {
...
THREAD(run_cont0) {
    ...
    cont sp0k;
    SN_BIND_VOID(SN_run_cont1, &sp0k);
    multiply_matrix_closure sp0c(sp0k);
    sp0c.A = largs->A;
    sp0c.oa = largs->y;
    sp0c.B = largs->B;
