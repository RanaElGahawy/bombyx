...
CLOSURE_DEF(worker, int x;);
CLOSURE_DEF(reduce, int *arr; int n;);
CLOSURE_DEF(reduce_exit0, int *arr; int n; Accum acc; int i; int r;);
CLOSURE_DEF(reduce_reentry0, int *arr; int n; Accum acc; int i; int r;);
CLOSURE_DEF(main_cont0, int result;);
CLOSURE_DEF(reduce_reentry0_cont0, int *arr; int n; Accum acc; int i; int r;);
...
THREAD(reduce_reentry0) {
  ...
  if ((largs->i < largs->n)) {
    ...
    spawn_next<reduce_reentry0_cont0_closure> SN_reduce_reentry0_cont0(
        SN_reduce_reentry0_cont0c);
    cont sp0k;
    ...
    ((reduce_reentry0_cont0_closure *)SN_reduce_reentry0_cont0.cls.get())->i =
        largs->i;
    ((reduce_reentry0_cont0_closure *)SN_reduce_reentry0_cont0.cls.get())->acc =
        largs->acc;
    ((reduce_reentry0_cont0_closure *)SN_reduce_reentry0_cont0.cls.get())->n =
        largs->n;
    ((reduce_reentry0_cont0_closure *)SN_reduce_reentry0_cont0.cls.get())->arr =
        largs->arr;
    // Original sync was here
  } else {
...
THREAD(reduce_reentry0_cont0) {
  reduce_reentry0_cont0_closure *largs =
      (reduce_reentry0_cont0_closure *)(args.get());
