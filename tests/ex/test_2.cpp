...
CLOSURE_DEF(compute_reentry3_exit4,
    long depth;
    long width;
    long threshold;
    unsigned long long result;
...
CLOSURE_DEF(compute_reentry3_reentry4,
    long depth;
    long width;
    long threshold;
    unsigned long long result;
...
CLOSURE_DEF(compute_reentry3_cont0,
    long depth;
    long width;
    long threshold;
    unsigned long long result;
...
CLOSURE_DEF(compute_reentry3_reentry4_cont0,
    long depth;
    long width;
    long threshold;
    unsigned long long result;
...
THREAD(compute_reentry0) {
    ...
    if ((largs->d < largs->depth)) {
        ...
        auto sp1c = std::make_shared<compute_exit0_closure>(largs->k);
        sp1c->depth = largs->depth;
        sp1c->width = largs->width;
        sp1c->threshold = largs->threshold;
        sp1c->result = largs->result;
        sp1c->acc = largs->acc;
        sp1c->pre_a = largs->pre_a;
        sp1c->pre_b = largs->pre_b;
        sp1c->d = largs->d;
        sp1c->w = largs->w;
        sp1c->a = largs->a;
        sp1c->b = largs->b;
...
THREAD(compute_reentry0_reentry1_cont0) {
    ...
    if ((largs->a > largs->b)) {
        ...
        auto sp1c = std::make_shared<compute_reentry0_reentry1_exit2_closure>(largs->k);
        sp1c->depth = largs->depth;
        sp1c->width = largs->width;
        sp1c->threshold = largs->threshold;
        sp1c->result = largs->result;
...
THREAD(compute_reentry3_cont0) {
    ...
    if ((largs->a0 > largs->threshold)) {
        largs->j = 0;
        auto sp0c = std::make_shared<compute_reentry3_reentry4_closure>(largs->k);
        sp0c->depth = largs->depth;
        sp0c->width = largs->width;
        sp0c->threshold = largs->threshold;
        sp0c->result = largs->result;
        ...
        auto sp1c = std::make_shared<compute_reentry3_exit4_closure>(largs->k);
        sp1c->depth = largs->depth;
        sp1c->width = largs->width;
        sp1c->threshold = largs->threshold;
        sp1c->result = largs->result;
